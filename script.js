document.addEventListener('DOMContentLoaded', () => {
    ...
    const categoriasPadrao = [
        ...
        { id: 'alimentacao', nome: 'Alimentação', icone: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a5 5 0 0 0-5 5v1a5 5 0 0 0 10 0V7a5 5 0 0 0-5-5zm0 0v1m-4 4h8m-8 4h8m-8 4h8m-8 4h8"></path></svg>' },
        { id: 'transporte', nome: 'Transporte', icone: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2l.64-2.56a2 2 0 00-1.95-2.44H12V6a2 2 0 10-4 0v6.5H4.29a2 2 0 00-1.95 2.44L3 17h2m0 0v4m14-4v4m-9-4v4"></path><circle cx="6" cy="6" r="2"></circle><circle cx="18" cy="6" r="2"></circle></svg>' },
    ...
    const renderizarContas = () => {
        ...
        contasFiltradas.sort((a, b) => new Date(a.vencimento) - new Date(b.vencimento)).forEach(conta => {
            ...
            // ** Ícones SVG completos restaurados aqui **
            ...
            card.innerHTML = `
                <div class="card-col-logo">
                    <img src="${logoSrc}" alt="Logo" class="logo-empresa">
                </div>
                <div class="card-col-info">
                    <h3>${conta.nome}</h3>
                    <div class="categoria-info">
                        ${categoriaObj.icone}
                        <span>${categoriaObj.nome}</span>
                    </div>
